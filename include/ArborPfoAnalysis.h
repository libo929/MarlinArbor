...
#ifndef ARBORPFO_ANALYSIS_H
#define ARBORPFO_ANALYSIS_H 1
...
/**
 *  @brief  ArborPfoAnalysis class
 */
class ArborPfoAnalysis : public marlin::Processor
{
public:
    /**
...
private:
    ...
    float               m_pfoEnergyTracksClusters;              ///< 
...
inline marlin::Processor *ArborPfoAnalysis::newProcessor()
{
    return new ArborPfoAnalysis;
}

#endif // #ifndef ARBORPFO_ANALYSIS_H
